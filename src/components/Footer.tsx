      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Automatize seu atendimento com chatbots inteligentes para WhatsApp.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="text-gray-600 hover:text-automazap-600 transition-colors">
                  Casos de Uso
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gray-200 text-center md:flex md:justify-between md:items-center">
          <p className="text-gray-500 mb-4 md:mb-0">
            &copy; {currentYear} AutomaZap. Todos os direitos reservados.
          </p>
          <div className="flex justify-center space-x-6">
            <a href="#" className="text-gray-400 hover:text-automazap-600">
